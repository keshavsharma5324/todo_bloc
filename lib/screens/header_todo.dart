      ...
      children: [
        ...
        BlocListener<TodoListBloc, TodoListState>(
          listener: (context, state) {
            ...
            context
                .read<PendingTodoCountBloc>()
                .add(CalculatePendingTodoCountEvent(activeTodoCount));
          },
          child: BlocBuilder<PendingTodoCountBloc, PendingTodoCountState>(
            builder: (context, state) {
              return Text(
                '${state.pendingTodoCount} items left',
